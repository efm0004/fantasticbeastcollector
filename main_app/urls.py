...
urlpatterns = [
    ...
    path('fantasticbeasts/<int:fantasticbeast_id>/add_photo/', views.add_photo, name='add_photo'),
    path('fantasticbeasts/<int:fantasticbeast_id>/assoc_toy/<int:toy_id/', views.assoc_toy, name='assoc_toy'),
    path('fantasticbeasts/<int:fantasticbeast_id>/unassoc_toy/<int:toy_id>/', views.assoc_toy, name='assoc_toy'),
